...
# read in data: individual scores
# # ... FULL DATASET
# dd_children = read.csv("/Users/kweisman/Documents/Research (Stanford)/Projects/GGW-kid/ggw-kid/data/children/kid-run-01&02_2016-01-07_data_anonymized.csv")[-1] # get rid of column of obs numbers
# 
# # ... RUN01
...
# ... RUN02
dd_children = read.csv("/Users/kweisman/Documents/Research (Stanford)/Projects/GGW-kid/ggw-kid/data/children/kid-run-02_2016-01-07_data_anonymized.csv")[-1] # get rid of column of obs numbers
...
graphics.off()
setwd("/Users/kweisman/Documents/Research (Stanford)/Projects/GGW-kid/ggw-kid/plots/raw_counts/")
