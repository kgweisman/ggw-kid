...
# # ... FULL DATASET
# dd = read.csv("/Users/kweisman/Documents/Research (Stanford)/Projects/GGW-kid/ggw-kid/data/kid-run-01&02_2015-07-21_data_anonymized.csv")[-1] # get rid of column of obs numbers
# 
# # ... RUN01
...
# ... RUN02
dd = read.csv("/Users/kweisman/Documents/Research (Stanford)/Projects/GGW-kid/ggw-kid/data/kid-run-02_2015-07-21_data_anonymized.csv")[-1] # get rid of column of obs numbers
...
fine.summary = temp %>%
  summarise(avg.grownup.kid = round(mean(grownup.kid, na.rm = T), 2),
            avg.grownup.baby = round(mean(grownup.baby, na.rm = T), 2),
            avg.grownup.dog = round(mean(grownup.dog, na.rm = T), 2),
            avg.grownup.bear = round(mean(grownup.bear, na.rm = T), 2),
            avg.grownup.bug = round(mean(grownup.bug, na.rm = T), 2),
            avg.grownup.robot = round(mean(grownup.robot, na.rm = T), 2),
            avg.grownup.computer = round(mean(grownup.computer, na.rm = T), 2),
            avg.grownup.car = round(mean(grownup.car, na.rm = T), 2),
            avg.grownup.stapler = round(mean(grownup.stapler, na.rm = T), 2),
            avg.kid.baby = round(mean(kid.baby, na.rm = T), 2),
            avg.kid.dog = round(mean(kid.dog, na.rm = T), 2),
            avg.kid.bear = round(mean(kid.bear, na.rm = T), 2),
            avg.kid.bug = round(mean(kid.bug, na.rm = T), 2),
            avg.kid.robot = round(mean(kid.robot, na.rm = T), 2),
            avg.kid.computer = round(mean(kid.computer, na.rm = T), 2),
            avg.kid.car = round(mean(kid.car, na.rm = T), 2),
            avg.kid.stapler = round(mean(kid.stapler, na.rm = T), 2),
            avg.baby.dog = round(mean(baby.dog, na.rm = T), 2),
            avg.baby.bear = round(mean(baby.bear, na.rm = T), 2),
            avg.baby.bug = round(mean(baby.bug, na.rm = T), 2),
            avg.baby.robot = round(mean(baby.robot, na.rm = T), 2),
            avg.baby.computer = round(mean(baby.computer, na.rm = T), 2),
            avg.baby.car = round(mean(baby.car, na.rm = T), 2),
            avg.baby.stapler = round(mean(baby.stapler, na.rm = T), 2),
            avg.dog.bear = round(mean(dog.bear, na.rm = T), 2),
            avg.dog.bug = round(mean(dog.bug, na.rm = T), 2),
            avg.dog.robot = round(mean(dog.robot, na.rm = T), 2),
            avg.dog.computer = round(mean(dog.computer, na.rm = T), 2),
            avg.dog.car = round(mean(dog.car, na.rm = T), 2),
            avg.dog.stapler = round(mean(dog.stapler, na.rm = T), 2),
            avg.bear.bug = round(mean(bear.bug, na.rm = T), 2),
            avg.bear.robot = round(mean(bear.robot, na.rm = T), 2),
            avg.bear.computer = round(mean(bear.computer, na.rm = T), 2),
            avg.bear.car = round(mean(bear.car, na.rm = T), 2),
            avg.bear.stapler = round(mean(bear.stapler, na.rm = T), 2),
            avg.bug.robot = round(mean(bug.robot, na.rm = T), 2),
            avg.bug.computer = round(mean(bug.computer, na.rm = T), 2),
            avg.bug.car = round(mean(bug.car, na.rm = T), 2),
            avg.bug.stapler = round(mean(bug.stapler, na.rm = T), 2),
            avg.robot.computer = round(mean(robot.computer, na.rm = T), 2),
            avg.robot.car = round(mean(robot.car, na.rm = T), 2),
            avg.robot.stapler = round(mean(robot.stapler, na.rm = T), 2),
            avg.computer.car = round(mean(computer.car, na.rm = T), 2),
            avg.computer.stapler = round(mean(computer.stapler, na.rm = T), 2),
            avg.car.stapler = round(mean(car.stapler, na.rm = T), 2)) %>%
...
coarse.summary = temp2 %>%
  group_by(coarse) %>%
  summarise(avg.feelings = round(mean(feelings, na.rm = T), 2),
            avg.hunger = round(mean(hunger, na.rm = T), 2),
            avg.thinking = round(mean(thinking, na.rm = T)), 2)
